...
render game = 
    ...
    where
        ...
        createPaddle col x y = pictures 
            [ translate x y $ color col $ rectangleSolid 10 60,
              translate x y $ color paddleColor $ rectangleSolid 5 55
            ]
...
speedIncrease :: PongGame -> PongGame
...
outOfPlayzone :: PongGame -> PongGame
...
handler :: Event -> PongGame -> PongGame
